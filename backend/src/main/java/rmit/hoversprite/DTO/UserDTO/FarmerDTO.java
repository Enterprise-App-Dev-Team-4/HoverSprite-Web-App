...
public class FarmerDTO extends UserDTO {
    public FarmerDTO() {}
    List<Farm> farms;
    public FarmerDTO(String id, String email, String fullName, String lastName, String firstName, String phoneNumber, String homeAddress, List<Farm> farms, Role role) {
